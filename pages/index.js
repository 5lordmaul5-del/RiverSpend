...
export default function Home() {
  ...
  return (
    <>
      ...
      <main style={{ minHeight: '100vh', backgroundColor: '#0040aa', color: '#ffffff', fontFamily: 'sans-serif', display: 'flex', justifyContent: 'center', padding: '15px', boxSizing: 'border-box', margin: 0 }}>
        <div style={{ width: '100%', maxWidth: '450px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          {toast && (
            <div style={{ position: 'fixed', bottom: '20px', background: '#10b981', color: 'white', padding: '10px 20px', borderRadius: '30px', fontWeight: 'bold', fontSize: '13px', boxShadow: '0 4px 12px rgba(0,0,0,0.3)', zIndex: 1000 }}>
              {toast}
            </div>
          )}
        </div>
